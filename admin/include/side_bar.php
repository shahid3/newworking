...
<li><button style="width:240px; height:50px" type="button" class="btn btn-default btn-primary" onClick="location.href='#'"><span class="glyphicon glyphicon-edit pull-left"></span> Customers </button></li>
 ...
 <li><a href="cosmetics_list.php"><strong> Electronic List</strong></a></li>
  ...
  <li>
  <button style="width:240px; height:50px" type="button" class="btn btn-default dropdown-toggle btn-primary" data-toggle="dropdown" aria-haspopup="false" aria-expanded="true">
  <span class="glyphicon glyphicon-edit pull-left"></span>User Management<span class="glyphicon glyphicon-triangle-bottom pull-right"></span>
  </button>
  <ul class="dropdown-menu" style="width:240px">
    <li><a href="manage_users.php"><strong>Users</strong> </a><a href="add_user.php"><strong>Add user</strong> </a></li>
 <li><a href="cosmetics_list.php"><strong>ACL</strong></a></li>
   </ul></li>
